...
if __name__ == '__main__':
    ...
    save_gradient_images(smooth_grad, file_name_to_export + '_SmoothGrad_colorRandom3')
    # Convert to grayscale
    grayscale_smooth_grad = convert_to_grayscale(smooth_grad)
    # Save grayscale gradients
    save_gradient_images(grayscale_smooth_grad, file_name_to_export + '_SmoothGrad_grayRandom3')
